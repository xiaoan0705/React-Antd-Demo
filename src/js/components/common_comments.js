...
import { Tabs,message,Form,Input,Button,CheckBox,Modal,Card,notification } from 'antd';
				...
				<Row>
					...
					{commentList}
						<Form onSubmit={this.handleSubmit.bind(this)}>
							...
							&nbsp;&nbsp;
							<Button type='primary' htmlType='button' onClick={this.addUserCollection.bind(this)}>收藏该页面</Button>
						</Form>
					</Col>
				</Row>
			</div>
